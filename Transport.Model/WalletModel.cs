...
namespace Transport.Model
{
    ...
    // ─── DRIVER EXPENSE ───────────────────────────────────────────────────────
    // UPDATED: Added VehicleCode and VehicleName properties
    ...
    public class DriverExpenseModel
    {
        ...
        public string Remarks { get; set; }
        public long? JobCode { get; set; }
        public int? VehicleCode { get; set; }        // NEW: Vehicle code for expense
        public string VehicleName { get; set; }      // NEW: Vehicle name for display
        public int? CreatedBy { get; set; }
        public DateTime CreatedDate { get; set; }
        public string DisplayCreatedDate { get; set; }
    }
